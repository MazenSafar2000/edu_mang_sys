...
@section('css')
    @toastr_css
@section('title')
    {{ trans('Teacher_trans.Add_new_offlineclass') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('indirect.teacher.store') }}" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label> {{ trans('Teacher_trans.Meeting_number') }} : <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label> {{ trans('Teacher_trans.Getting_started_link') }} : <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label>  {{ trans('Teacher_trans.Login_link_for_students') }} : <span class="text-danger">*</span></label>
