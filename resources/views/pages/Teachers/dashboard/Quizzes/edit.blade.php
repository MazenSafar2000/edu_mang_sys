...
@section('css')
    @toastr_css
@section('title')
    {{ trans('Teacher_trans.edit_quizz') }} : {{ $quizz->name }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="number" name="duration"
                                        ...
                                        placeholder="{{ trans('Teacher_trans.enter_test_duration') }}" value="{{ $quizz->duration }}" required>
                                    @error('duration')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="datetime-local" name="start_at"
                                        class="form-control @error('start_at') is-invalid @enderror" value="{{ $quizz->start_at}}" required>
                                    @error('start_at')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col">
                                    ...
                                    <input type="datetime-local" name="end_at"
                                        class="form-control @error('end_at') is-invalid @enderror" value="{{ $quizz->end_at}}" required>
                                    @error('end_at')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
