                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('Quizzes.store') }}" method="post" autocomplete="off">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <label for="Name_ar">{{ trans('main_trans.exam_name_ar') }}</label>
                                    <input type="text" name="Name_ar" class="form-control">
                                </div>

                                <div class="col">
                                    <label for="Name_en">{{ trans('main_trans.exam_name_en') }}</label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="Grade_id">{{ trans('main_trans.gradate_one') }}: <span
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="Grade_id">{{ trans('main_trans.teacher_name') }} : <span
                                                class="text-danger">*</span></label>
                                        <select class="custom-select mr-sm-2" name="teacher_id">
                                            <option selected disabled>{{ trans('main_trans.select_teacher_name') }}
                                            </option>
