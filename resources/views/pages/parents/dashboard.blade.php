                                        ...
                                        <div class="card-body">
                                            <div class="text-center">
                                                <h5 style="font-family: 'Cairo', sans-serif" class="card-title">
                                                    {{ $son->name }}</h5>
                                                <p class="text-muted mb-4">{{ __('Parent_trans.student_information') }}
                                                </p>
                                            </div>
                                            <div>
                                                <div class="d-flex justify-content-between">
                                                    <span>{{ __('Parent_trans.grade') }}</span><span>{{ $son->grade->Name }}</span>
                                                </div>
                                                <div class="d-flex justify-content-between">
                                                    <span>{{ __('Parent_trans.class_room') }}</span><span>{{ $son->classroom->Name_Class }}</span>
                                                </div>
                                                <div class="d-flex justify-content-between">
