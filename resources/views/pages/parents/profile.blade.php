                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{route('profile.update.parent',$information->id)}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <p class="mb-0">{{ __('Parent_trans.parent_name') }}</p>
                                    </div>
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">
                                            @if(App::getLocale() === 'ar')
                                            <input type="text" name="Name_ar" value="{{ $information->getTranslation('Name_Father', 'ar') }}" class="form-control">
                                        @else
                                            <input type="text" name="Name_ar" value="{{ $information->getTranslation('Name_Father', 'en') }}" class="form-control">
                                        @endif
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="checkbox" class="form-check-input" onclick="myFunction()"
                                               id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1">{{ __('Parent_trans.show_password')}}</label>
                                    </div>
                                </div>
                                <hr>
